...
const app = createApp(App); // App.vue를 중심으로 앱 시작
...
app.use(pinia);
app.use(router);        //router → 페이지 이동 기능
app.use(vuetify);       //vuetify → UI 라이브러리
app.mount('#app');      //index.html의 <div id="app"></div> 여기에 Vue를 붙임